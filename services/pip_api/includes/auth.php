<?php
/**
 * Server-side API key validation for PIP Phase 2 internal API endpoints.
 *
 * Required request header:
 * X-PIP-API-Key
 *
 * The expected key must be stored server-side only. It may be supplied through
 * environment variable PIP_API_KEY or a local config file excluded from Git.
 */
